...
[compare changes](https://github.com/randriese/nuxt-auth-utils/compare/v0.8.4...v0.8.5)

## v0.8.4

[compare changes](https://github.com/randriese/nuxt-auth-utils/compare/v0.8.3...v0.8.4)

## v0.8.3

[compare changes](https://github.com/randriese/nuxt-auth-utils/compare/v0.8.2...v0.8.3)
...
- **release:** V0.5.22 ([c6e3ac3](https://github.com/atinux/nuxt-auth-utils/commit/c6e3ac3))
- Update deps ([7e86ab9](https://github.com/atinux/nuxt-auth-utils/commit/7e86ab9))
- **release:** V0.5.23 ([b25dae7](https://github.com/atinux/nuxt-auth-utils/commit/b25dae7))
- Update all deps ([#448](https://github.com/atinux/nuxt-auth-utils/pull/448))
- **release:** V0.5.24 ([0ff5cc7](https://github.com/atinux/nuxt-auth-utils/commit/0ff5cc7))
...
- **release:** V0.5.25 ([71737c2](https://github.com/atinux/nuxt-auth-utils/commit/71737c2))
...
- **release:** V0.5.26 ([379e5fb](https://github.com/atinux/nuxt-auth-utils/commit/379e5fb))
- Update deps ([16e307e](https://github.com/atinux/nuxt-auth-utils/commit/16e307e))
- **release:** V0.5.27 ([77dd086](https://github.com/atinux/nuxt-auth-utils/commit/77dd086))
- Add types for Kick and Twitch providers ([#489](https://github.com/atinux/nuxt-auth-utils/pull/489))
- **release:** V0.5.28 ([3794a03](https://github.com/atinux/nuxt-auth-utils/commit/3794a03))
...
- Yaroslav Semennikov
- Kubo997
- Jeffrey León <jals1212@gmail.com>
- Robert Stein
...
- Tom Lewis ([@tomlewis0](https://github.com/tomlewis0))
- Dog
...
- Tejas  Gavankar
- Artemis Mendrinos <artemis@mendrinos.com>
- Timothy Michael McMasters
- Phof
...
- Alessandro Jean
- David
- Jonas ([@jonasfroeller](https://github.com/jonasfroeller))
- Devskillpro ([@devskillpro](https://github.com/devskillpro))
- Exit ([@exitss](https://github.com/exitss))
...
- David Stranava ([@stranavad](https://github.com/stranavad))
- Brian Coleman <me@brianac.dev>
- Aoor9 ([@aoor9](https://github.com/aoor9))
- Velka
...
- José Manuel Madriaza Caravia ([@LeoMo-27](https://github.com/LeoMo-27))
- Jakub Frelik <j.frelik.it@outlook.com>
- Uģis ([@BerzinsU](https://github.com/BerzinsU))
- Sigve Hansen <sighan12@gmail.com>
- Arash
- Samuel LEFEVRE ([@samulefevre](https://github.com/samulefevre))
- Antoine Lassier <toinousp@gmail.com>
- Akshara Hegde ([@aksharahegde](https://github.com/aksharahegde))
